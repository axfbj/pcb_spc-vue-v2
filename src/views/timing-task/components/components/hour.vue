      ...
      <el-form-item>
        <el-radio-group v-model="form.radio" @change="radio_change">
          ...
          <el-radio :label="2">
            ...
            <el-input-number v-model="form.input1" style="width: 200px;" :controls="false" :min="0" :max="22" @change="input_change" />
            <span class="custum-label" style="width: 90px; text-align: center;">-</span>
            <el-input-number v-model="form.input2" style="width: 200px;;" :controls="false" :min="1" :max="23" @change="input_change" />
            小时
          </el-radio>
          <el-radio :label="3">
            <span class="custum-label">从</span>
            <el-input-number v-model="form.input3" style="width: 200px;" :controls="false" :min="0" :max="22" @change="input_change" />
            <span class="custum-label" style="width: 90px;">&nbsp;小时开始，每</span>
            <el-input-number v-model="form.input4" style="width: 200px;" :controls="false" :min="1" :max="23" @change="input_change" />
            小时执行一次
          </el-radio>
          <el-radio :label="4">指定
            <br>
            <el-checkbox-group v-model="form.checkList" style="margin-left: 20px;">
              <el-checkbox v-for="index of 24" :key="index-1" :label="index-1" @change="input_change">
