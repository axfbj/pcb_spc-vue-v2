      ...
      <el-form-item>
        <el-radio-group v-model="form.radio" @change="radio_change">
          ...
          <el-radio :label="2">
            ...
            <el-input-number v-model="form.input2" style="width: 200px; border-left-width: 0;" :controls="false" :min="1" :max="59" @change="input_change" />
            秒
          </el-radio>
          <el-radio :label="3">
            <span class="custum-label">从</span>
            <el-input-number v-model="form.input3" placeholder="" style="width: 200px;" :controls="false" :min="0" :max="59" @change="input_change" />
            <span class="custum-label" style="width: 80px;">&nbsp;秒开始，每</span>
            <el-input-number v-model="form.input4" placeholder="" style="width: 200px;" :controls="false" :min="1" :max="59" @change="input_change" />
            秒执行一次
          </el-radio>
          <el-radio :label="4">指定
            <br>
            <el-checkbox-group v-model="form.checkList" style="margin-left: 20px;" @change="input_change">
              <el-checkbox v-for="index of 60" :key="index-1" :label="index-1">
